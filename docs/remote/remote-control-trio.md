...
Starting with *LoopFollow* v3.3 and *Trio* v0.5.2, users of remote control are provided with real-time notifications for the results of remote commands. This requires a paired change to both *Trio* and *LoopFollow*.
...
!!! important "Breaking Change: *Trio* Remote Command Users"
    ...
    * LoopFollow v3.3.0 (or newer) works with *Trio* v0.5.2 (or newer)
